...
def general_plotter(plotting_dict, xlabel, ylabel, x_start, xlim_start, offset_multiply):
...
def test_plotter(plotting_dict, xlabel, ylabel, x_start, xlim_start, offset_multiply):
    """"Plots the efficiency to thrust multiple file"""
    fig, ax = plt.subplots()
    lim_x = 0
    lim_y = 0
